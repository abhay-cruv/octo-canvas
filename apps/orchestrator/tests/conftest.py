...
os.environ.setdefault(
    "MONGODB_URI", "mongodb://localhost:27017/vibe_platform_test"
)
...
from db.models import Session, User  # noqa: E402
...
async def client() -> AsyncIterator[httpx.AsyncClient]:
    ...
    await motor_client[TEST_DB_NAME][User.Settings.name].delete_many({})
    await motor_client[TEST_DB_NAME][Session.Settings.name].delete_many({})
    await init_beanie(
